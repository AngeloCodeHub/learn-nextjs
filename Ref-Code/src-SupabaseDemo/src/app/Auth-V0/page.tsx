...
export default function LoginPage() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('http://xn--djroe106hl2fyz1bszc.online/gradient-background.jpg')`,
    ...
    >
      ...
      >
        <CardHeader className="text-center space-y-2">
          <CardTitle className="text-3xl font-bold font-sans text-card-foreground">北半球電競館</CardTitle>
